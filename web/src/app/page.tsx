...
const steps = [
  { title: 'Choose the service', body: 'Pick haircut, beard, or combo + add-ons.' },
  { title: 'Pick a time', body: 'We only show free time slots (15 min blocks).' },
  { title: 'Confirm', body: 'Quick summary + (mocked) email confirmation.' },
];
    ...
    <div className="space-y-10">
      <section className="grid gap-8 rounded-3xl bg-white p-6 shadow-sm md:grid-cols-[1.1fr_0.9fr] md:p-8">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="/book"
              className="rounded-full bg-[#1a132f] px-5 py-3 text-white shadow-md shadow-[#1a132f]/20 transition hover:translate-y-[-1px] hover:brightness-110"
            >
              Book now
            </a>
            <a
      ...
      <section className="grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-3xl bg-white p-6 shadow-sm md:p-8">
          <div className="flex items-center justify-between">
            ...
            <a href="/book" className="text-sm font-semibold text-[#5b4fe5] hover:underline">
              See availability
            </a>
          </div>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-sm text-[#7b7794]">A partir de</p>
      ...
      <section className="grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-3xl bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="text-sm text-[#5a5872]">Mocked on the front-end; consent capture will be handled in the backend.</p>
          <div className="mt-5 space-y-4">
            {[
              {
                name: 'Daniel Johnson',
        ...
        <div className="rounded-3xl bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-5 space-y-4">
            ...
            <div className="rounded-2xl border border-[#ecebf5] bg-[#fcfcff] p-4">
              ...
              <p className="text-sm text-[#5a5872]">Mock gallery—backend will handle uploads + consent.</p>
            </div>
          </div>
        </div>
      </section>
